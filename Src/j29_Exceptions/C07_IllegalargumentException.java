...
public class C07_IllegalargumentException {  public static void main(String[] args) {
    // IllegalargumentException -> kullanılmasını istenmeyen değerlerde pr hata vermesi isteniyorsa bu excp fırlatıver
