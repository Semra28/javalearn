...
public class C01_HashSet {   /*
    ...
    public static void main(String[] args) {
        HashSet<String> hs =new HashSet<>();//boş bir hash set
        HashSet<String> hs1 =new HashSet<>(Arrays.asList("Ercan", "Yakup","Adem","Rukiye","Nur")); // elemaan ataması yapılan bir haset
        //Set print etme...
        System.out.println("hs1="+hs1);//[Ercan,Adem,Nur,Yakup,Rukiye]
        //set add()->eleman ekleme...
        hs1.add("Kevser");
        System.out.println("hs1="+hs1);//Kevser ismini hs1 eklemiş olduk
        hs1.add("Adem");//tekrarlı eleman ekleme
        System.out.println("hs1="+hs1);//adem ismini hs1 ekle

        hs1.add(null);
        hs1.add(null);
        hs1.add(null);
        System.out.println("hs1="+hs1);//null eklendi
        HashSet<String>hs2=new HashSet<>(Arrays.asList("Basarı","Gayrete ","Asıktır"));
        System.out.println("hs2="+hs2);//[Başarı,Asıktır,Gayrete]
        hs1.addAll(hs2);
        System.out.println("hs1="+hs1);//[null,Basarı,Ercan,Adem,Kevser,Asıktır,Nur,Yakup,Rukiye,Gayrete]

        //set remove()->isteyen eleman setten silinir.
        ...
        System.out.println("hs1.remove(hs2) = " + hs1.remove(hs2));//true
        System.out.println("hs1="+hs1);//[null,Ercan,Adem,Kevser,Nur,Yakup,Rukiye]

        System.out.println("hs1.size()="+hs1.size());//9
